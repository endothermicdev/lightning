...
u8 *towire_gossipd_remote_channel_update(const tal_t *ctx UNNEEDED, u32 remote_feerate_base UNNEEDED, u32 remote_feerate_ppm UNNEEDED, u16 remote_cltv_expiry_delta UNNEEDED, struct amount_msat remote_htlc_minimum_msat UNNEEDED, struct amount_msat remote_htlc_maximum_msat UNNEEDED)
