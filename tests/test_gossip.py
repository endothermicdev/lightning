...
def test_node_reannounce(node_factory, bitcoind, chainparams):
    ...
    msgs = l1.query_gossip('gossip_timestamp_filter',
                           ...
                           # And pings.
                           filters=['0109', '0107', '0102', '0100', '0012', '0007'])
...
def test_gossip_ratelimit(node_factory, bitcoind):
    ...
    # Channel update
    # Peer storage blob
    update = raw.decode('utf-8').split()[-2]
    decoded = subprocess.run(['devtools/decodemsg', update],
                             check=True,
                             timeout=TIMEOUT,
