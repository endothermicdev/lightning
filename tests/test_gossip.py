...
def test_corrupt_gossip_store(node_factory, bitcoind):
    ...
    Corrupt the gossip_store to try reading junk gossip to peer."""
    opts={'allow_bad_gossip': True}
    l1, l2 = node_factory.get_nodes(2, opts=opts)
    time.sleep(3)
    # append an empty gossip_store with a bad checksum msg to test
    # bad offset debugging.
    with open(os.path.join(l1.daemon.lightning_dir, TEST_NETWORK, 'gossip_store'), 'ab') as f:
        f.write(bytearray.fromhex("000001b0"  # len
                                  "fea676e8"  # csum
                                  "5b8d9b44"  # timestamp
                                  "0100"      # WIRE_CHANNEL_ANNOUNCEMENT
                                  ""
    ...
    l1.rpc.connect(l2.info['id'], 'localhost', l2.port)
    l1.daemon.wait_for_log(r"seeker: startup peer finished", timeout=20)
