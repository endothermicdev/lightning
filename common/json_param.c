 ...
 * testnet/mainnet/regtest/signet/mutinynet/testnet4
 *
 ...
 * set whether it is testnet/testnet4/signet/mutinynet (all "tb"),  mainnet
 * ("bc"), regtest ("bcrt"). It does not check witness version and program size
 * restrictions.
 *
